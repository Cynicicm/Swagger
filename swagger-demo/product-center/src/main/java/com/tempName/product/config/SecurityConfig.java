package com.tempName.product.config;

import com.tempName.commons.common.entity.User;
import com.tempName.commons.common.model.UserDetailsModel;
import com.tempName.commons.common.utils.AppUserUtil;
import com.tempName.commons.component.JwtAuthenticationTokenFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public UserDetailsService userDetailsService() {
        // 获取登录用户信息
        return username -> {
            User user = iUserDetailsService.selectByUsername(username);
            AppUserUtil.setLoginUser(user);
            if (user != null) {
